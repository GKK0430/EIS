									...
									success : function(rs) {
										...
										for (var i = 0; i < rs2.length; i++) {
											...
											str += '<div class="card">'
												...
												+'<span>附件:</span><p><a class="AttachedFilesName" href="http://localhost:8080/EIS/download?BulletinBoardID='+rs2[i].BulletinBoardID+'&fileName='+rs2[i].AttachedFilesName+'">' + rs2[i].AttachedFilesName + '</a></p>'												
